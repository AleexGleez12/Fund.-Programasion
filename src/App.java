...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Titulo del producto: " + product.title);
        System.out.println("Nombre de la categoria: " + product.category.name);
        System.out.println("Fecha de creacion: " + product.creationAt);
    }
}